  ...
  return (
    <>
      {session ? (
        ...
        <button onClick={() => {handleSignInModal("open")}} className="flex h-14 items-center gap-2 rounded-md bg-neutral-800 px-2 py-2 outline outline-1 outline-neutral-600">
          <div
